...
export const onDataLoad = new chrome.Event()

let setStaleData
export const cacheLoaded = new Promise(resolve => {
...
export function updateTempWithUnit(unit) {
  if (!data || !unit) {
    return
  }
...
export function getSunInfoMS(givenData) {
  return (givenData
